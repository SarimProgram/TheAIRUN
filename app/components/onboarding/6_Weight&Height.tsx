...
import { ChevronLeft, ArrowRight, Ruler, Weight } from 'lucide-react-native';
      ...
      <SafeAreaView style={styles.flex}>
        ...
        <View style={styles.main}>
          ...
          <Animated.View style={[styles.pickerSection, { opacity: fadeAnim }]}>
            <View style={styles.pickerWrapperOuter}>
...
const styles = StyleSheet.create({
  ...
  valueText: { fontSize: 36, fontWeight: '900', letterSpacing: -1.5 },
  ...
  resultDisplay: { alignItems: 'center', marginTop: 15 },
  ...
  resultValue: { fontSize: 52, fontWeight: '900', color: COLORS.black, letterSpacing: -2 },
